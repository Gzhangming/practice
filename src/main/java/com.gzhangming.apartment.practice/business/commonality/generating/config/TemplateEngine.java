...
import com.gzhangming.apartment.practice.business.commonality.generating.builder.ConfigBuilder;
...
import com.gzhangming.apartment.practice.business.commonality.generating.util.BaseFieldUtil;
import com.gzhangming.apartment.practice.business.commonality.generating.util.StrKit;
import com.gzhangming.apartment.practice.business.commonality.generating.util.ToolUtil;
...
public class TemplateEngine {
    ...
    public TemplateEngine(com.gzhangming.apartment.practice.business.commonality.generating.DataSourceConfig dataSourceConfig, TempConfig config) {
        initBeetlEngine();
        initTableList(dataSourceConfig);
        tempConfig = config;
    }

    protected void initTableList(com.gzhangming.apartment.practice.business.commonality.generating.DataSourceConfig dataSourceConfig) {
